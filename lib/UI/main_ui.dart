...
import 'package:flutter_multithme/Model/categoryModel.dart';
import 'package:flutter_multithme/Model/productModel.dart';
import 'package:flutter_multithme/Model/theme_model.dart';
import 'package:flutter_multithme/UI/Widgets/custom_shape.dart';
import 'package:flutter_multithme/UI/Widgets/mainui_customcard.dart';
          ...
          return Scaffold(
            ...
            floatingActionButton: FloatingActionButton.extended(
              ...
              label: Text(
                ...
                style: TextStyle(
                    color: Colors.black, fontFamily: 'GilroyMedium',fontWeight: FontWeight.bold),
              ),
            ),
    ...
    return BottomAppBar(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            IconButton(
              icon: Image.asset('assets/images/mail.png',scale: 3,color: Colors.white,),
              onPressed: () {},
            ),
            IconButton(
              icon: Image.asset('assets/images/calendar.png',scale: 3.5,color: Colors.white,),
              onPressed: () {},
            )
          ],
        ),
